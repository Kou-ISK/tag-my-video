...
export const VideoPlayerApp = () => {
    const {
        ...
        setPackagePath, addTimelineData, deleteTimelineDatas, updateQualifier, updateActionResult, updateActionType, getSelectedTimelineId, sortTimelineDatas
    } = useVideoPlayerApp();
        ...
        <>
            {isFileSelected && <><Box sx={{ display: 'flex', flexDirection: 'row', maxHeight: '50vh', margin: '0px' }}>
                ...
                <Box sx={{ maxHeight: '50vh', display: 'flex', flexDirection: 'row', alignContent: 'space-between' }}>
                    ...
                    <CodePanel metaDataConfigFilePath={metaDataConfigFilePath} addTimelineData={addTimelineData} teamNames={teamNames} setTeamNames={setTeamNames} />
                </Box>
